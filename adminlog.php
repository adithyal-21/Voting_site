...
<body>
<div class="container">
<form action="includes/adminlog.inc.php" class="form-horizontal" method="POST"><br>
    <div class="row justify-content-center">
        <div class="col-sm-6">
            <div class="card"  id="cards">
                <div class="card-header" style="border-top-left-radius: 25px; ">Log in as Admin</div>
                    <div class="card-body">
<br>
                    <div class="row justify-content-center">
                            <div class="col-sm-10">
    ...
    if(isset($_GET['error']))
        {
            ...
            <div style="text-align:center">	
                <input type="submit" value="Login" class="btn btn-dark" id="button" name="yes">
            </div>
